...
public class Seed implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        Post p1 = new Post(null, LocalDate.parse("2018-03-21", ftm1),"Partiu viagem", "Vou viajar para São Paulo. Abraços!", u1);
        Post p2 = new Post(null, LocalDate.parse("2018-03-23", ftm1), "Bom dia", "Acordei feliz hoje!", u1);
